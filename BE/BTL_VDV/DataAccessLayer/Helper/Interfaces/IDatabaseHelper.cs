...
namespace DataAccessLayer
{
    ...
    public interface IDatabaseHelper
    {
        ...
        object ExecuteScalar(string strquery, out string msgError, params SqlParameter[] parameters);
        int ExecuteNoneQuery2(string strquery, params SqlParameter[] parameters);
