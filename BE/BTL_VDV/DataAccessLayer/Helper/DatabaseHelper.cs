...
namespace DataAccessLayer
{
    public class DatabaseHelper : IDatabaseHelper
    {
        ...
        //    return result;
        //}
        public object ExecuteScalar(string strquery, out string msgError, params SqlParameter[] parameters)
        {
            object result = null;
            msgError = "";
            try
        ...
        //chay cau lenh truc tiep 
        public int ExecuteNoneQuery2(string query, params SqlParameter[] parameters)
        {
            int rowsAffected = 0;
            try
            {
        ...
        //chạy câu lệnh SQL trực tiếp trả về DataTable
        public DataTable ExecuteQueryReturnDataTable(string query, params SqlParameter[] parameters)
        {
        ...
        public DataTable ExecuteQuery(string sql, out string msgError, params SqlParameter[] parameters)
        {
            msgError = "";
            ...
            catch (Exception ex)
            {
                ...
                dt = null;  // Trả về null nếu lỗi
            }

            return dt;
        }
        //Hàm gọi cho phép truyền biến tên sản phẩm vào
        public DataTable ExecuteQueryReturnDataTable2(string sql, SqlParameter[] parameters)
        {
            using (var conn = new SqlConnection(StrConnection)) // ← dùng đúng tên biến
            using (var cmd = new SqlCommand(sql, conn))
            {
                if (parameters != null)
                {
